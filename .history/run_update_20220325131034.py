...
if ONSTART_DOWNLOAD:
    ...
    print(LICENSE_KEY, DOWNLOAD_ABSPATH, DB_EDITION)
    download_process = subprocess.Popen(['php', 'download.php', 
        '--license-key', LICENSE_KEY,
        '--output-path', DOWNLOAD_ABSPATH,
        '--edition', DB_EDITION],
        stdout = subprocess.PIPE)
    with download_process.stdout:
        print(download_process.stdout)
    exitcode = download_process.wait()
