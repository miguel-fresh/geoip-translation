...
on_start:
  download_zip: true # Ejecutar la descarga del zip (si es true, se ejecuta antes de convertir)
  convert_to_dat: true # Ejecutar la conversión de formato (si es true, se ejecuta después de descargar)
